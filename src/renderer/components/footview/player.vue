<template>
    <div class="player">
        ...
        <div class="cover">
            ...
            <audio v-show="false" ref="audio" preload/>
        </div>
        <!-- <div class="tone">
                ...
                <el-dropdown-menu slot="dropdown" style="width: 220px">
                    ...
                    <el-dropdown-item>
                        <div class="flex-c-l">
                            <div class="check" style="width: 30px"></div>
                            <span>SQ无损品质</span>
                            <img src="~@/assets/imgs/svip.png" style="margin-left: 5px; width: 22px"/>
                            <img src="~@/assets/imgs/sui.png" style="margin-left: 5px; width: 22px"/>
                        </div>
                    </el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
            ...
            <div class="top">
                <div class="names">
                    <div>
                        ...
                        <span class="ar_name"> - 我在你方圆几里</span>
                    </div>
                </div>
                <div class="time">02:34 / 04:03</div>
            </div>
            <div class="progress">
                <el-slider :show-tooltipss="true" v-model="play_time" input-size="mini" :min="0" :max="3/1000"
        ...
        <div class="actions">
            ...
            <el-popover
                ...
                <el-button type="text" @click.native="showPlaylist" slot="reference">
                    <i class="iconfont icon-liebiao" style="margin-left: 10px;"></i>
                </el-button>
            </el-popover>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            name() {
                try {
                    return this.song.name || '网易云音乐，畅听无限'
                } catch (e) {
                    return '网易云音乐，畅听无限'
                }
            },
